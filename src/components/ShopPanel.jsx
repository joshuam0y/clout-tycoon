...
export const ShopPanel = ({
  ...
  return (
    <div className="shop-panel panel">
      ...
      <p className="shop-tagline">Prices rise 15% per copy — stack your empire.</p>
      ...
      <div className="shop-section">
        ...
        <div className="shop-items">
          {availableInfluencers.map(influencer => {
            ...
            const nextCost = scaledUnitCost(influencer.cost, owned);
      ...
      <div className="shop-section">
        ...
        <div className="shop-items">
          {availableBuildings.map(building => {
            ...
            const nextCost = scaledUnitCost(building.cost, owned);
            const canAfford = clout >= nextCost;
            ...
            return (
              ...
              >
                ...
                <div className="item-meta">
                  ...
                  <span className="item-cost" style={{ color: canAfford ? building.color : '#666688' }}>
                    {formatNumber(nextCost)} Clout
                  </span>
                </div>
                {isSelected && <div className="selected-indicator">Click grid to place</div>}
